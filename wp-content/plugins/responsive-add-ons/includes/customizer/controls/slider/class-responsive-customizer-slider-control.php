...
if ( ! class_exists( 'Responsive_Customizer_Slider_Control' ) ) :
	...
	class Responsive_Customizer_Slider_Control extends WP_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'responsive-slider', RESPONSIVE_ADDONS_URI . 'core/includes/customizer/assets/min/js/slider.min.js', array( 'jquery', 'customize-base', 'jquery-ui-slider' ), RESPONSIVE_ADDONS_VER, true );
			wp_enqueue_style( 'responsive-slider', RESPONSIVE_ADDONS_URI . 'core/includes/customizer/assets/min/css/slider.min.css', array(), RESPONSIVE_ADDONS_VER, true );
		}
